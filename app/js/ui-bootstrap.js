...
.directive('accordion', function () {
  return {
    ...
    transclude: true,
    replace: false,
    templateUrl: '/app/partials/bootstrap/accordion/accordion.html'
  };
})
...
.directive('accordionGroup', ['$parse', '$transition', '$timeout', function($parse, $transition, $timeout) {
  return {
    ...
    templateUrl:'/app/partials/bootstrap/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
  return {
    restrict:'EA',
    templateUrl:'/app/partials/bootstrap/alert/alert.html',
    transclude:true,
    replace:true,
    scope: {
      type: '=',
...
.directive('carousel', [function() {
  return {
    ...
    require: 'carousel',
    templateUrl: '/app/partials/bootstrap/carousel/carousel.html',
    scope: {
      interval: '=',
      noTransition: '=',
      noPause: '='
...
.directive('slide', ['$parse', function($parse) {
  return {
    ...
    transclude: true,
    replace: true,
    templateUrl: '/app/partials/bootstrap/carousel/slide.html',
    scope: {
    },
...
.directive( 'datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
  return {
    restrict: 'EA',
    replace: true,
    templateUrl: '/app/partials/bootstrap/datepicker/datepicker.html',
    scope: {
      dateDisabled: '&'
    },
...
.directive('datepickerPopupWrap', [function() {
  return {
    ...
    replace: true,
    transclude: true,
    templateUrl: '/app/partials/bootstrap/datepicker/popup.html',
    link:function (scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
    ...
    return {
      ...
      messageBox: function(title, message, buttons){
        return new Dialog({templateUrl: '/app/partials/bootstrap/dialog/message.html', controller: 'MessageBoxController', resolve:
          {model: function() {
            return {
              title: title,
              message: message,
...
.directive('pagination', ['paginationConfig', function(config) {
  return {
    ...
    templateUrl: '/app/partials/bootstrap/pagination/pagination.html',
    replace: true,
...
.directive('pager', ['pagerConfig', function(config) {
  return {
    ...
    controller: 'PaginationController',
    templateUrl: '/app/partials/bootstrap/pagination/pager.html',
    replace: true,
    link: function(scope, element, attrs, paginationCtrl) {
...
.directive( 'tooltipPopup', function () {
  return {
    ...
    templateUrl: '/app/partials/bootstrap/tooltip/tooltip-popup.html'
  };
})
...
.directive( 'tooltipHtmlUnsafePopup', function () {
  return {
    ...
    replace: true,
    scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
    templateUrl: '/app/partials/bootstrap/tooltip/tooltip-html-unsafe-popup.html'
  };
})
...
.directive( 'popoverPopup', function () {
  return {
    ...
    templateUrl: '/app/partials/bootstrap/popover/popover.html'
  };
})
...
.directive('progress', function() {
    return {
        ...
        templateUrl: '/app/partials/bootstrap/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function($transition) {
    return {
        ...
        templateUrl: '/app/partials/bootstrap/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function(ratingConfig, $parse) {
  return {
    ...
    templateUrl: '/app/partials/bootstrap/rating/rating.html',
    replace: true,
    link: function(scope, element, attrs) {
...
.directive('tabset', function() {
  return {
    ...
    templateUrl: '/app/partials/bootstrap/tabs/tabset.html',
...
function($parse, $http, $templateCache, $compile) {
  return {
    ...
    restrict: 'EA',
    replace: true,
    templateUrl: '/app/partials/bootstrap/tabs/tab.html',
    transclude: true,
    scope: {
      heading: '@',
...
.directive('tabsetTitles', function($http) {
  return {
    restrict: 'A',
    require: '^tabset',
    templateUrl: '/app/partials/bootstrap/tabs/tabset-titles.html',
    replace: true,
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
  return {
    ...
    require:'ngModel',
    replace: true,
    templateUrl: '/app/partials/bootstrap/timepicker/timepicker.html',
    scope: {
        model: '=ngModel'
    },
    link: function(scope, element, attrs, ngModelCtrl) {
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl:'/app/partials/bootstrap/typeahead/typeahead-popup.html',
      link:function (scope, element, attrs) {
  ...
  .directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse', function ($http, $templateCache, $compile, $parse) {
    return {
      ...
      link:function (scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || '/app/partials/bootstrap/typeahead/typeahead-match.html';
