var bootstrapTemplateBase = '/app/partials/bootstrap';
...
.directive('accordion', function () {
    return {
        ...
        transclude: true,
        replace: false,
        templateUrl: bootstrapTemplateBase + '/accordion/accordion.html'
    };
})
...
.directive('accordionGroup', ['$parse', '$transition', '$timeout', function ($parse, $transition, $timeout) {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/accordion/accordion-group.html',
...
angular.module("ui.bootstrap.alert", []).directive('alert', function () {
    return {
        restrict: 'EA',
        templateUrl: bootstrapTemplateBase + '/alert/alert.html',
        transclude: true,
        replace: true,
        scope: {
            type: '=',
...
.directive('carousel', [function () {
    return {
        ...
        require: 'carousel',
        templateUrl: bootstrapTemplateBase + '/carousel/carousel.html',
        scope: {
            interval: '=',
            noTransition: '=',
            noPause: '='
...
.directive('slide', ['$parse', function ($parse) {
    return {
        ...
        transclude: true,
        replace: true,
        templateUrl: bootstrapTemplateBase + '/carousel/slide.html',
        scope: {
        },
...
.directive('datepicker', ['dateFilter', '$parse', 'datepickerConfig', '$log', function (dateFilter, $parse, datepickerConfig, $log) {
    return {
        restrict: 'EA',
        replace: true,
        templateUrl: bootstrapTemplateBase + '/datepicker/datepicker.html',
        scope: {
            dateDisabled: '&'
        },
...
.directive('datepickerPopupWrap', [function () {
    return {
        ...
        replace: true,
        transclude: true,
        templateUrl: bootstrapTemplateBase + '/datepicker/popup.html',
        link: function (scope, element, attrs) {
  ...
  function ($http, $document, $compile, $rootScope, $controller, $templateCache, $q, $transition, $injector) {
      ...
      return {
          ...
          messageBox: function (title, message, buttons) {
              return new Dialog({
                  templateUrl: bootstrapTemplateBase + '/dialog/message.html', controller: 'MessageBoxController', resolve:
              {
                  model: function () {
                      return {
                          title: title,
...
angular.module('ui.bootstrap.dropdownToggle', []).directive('dropdownToggle', ['$document', '$location', '$parse', function ($document, $location, $parse) {
    ...
    return {
        ...
        link: function (scope, element, attrs) {
            ...
            var preventCloseOnClick = attrs.preventCloseOnClick && angular.lowercase(attrs.preventCloseOnClick) == 'true';
            if (attrs.preventCloseOnClick) {
                scope.$parent.$watch($parse(attrs.preventCloseOnClick), function (value) {
                    preventCloseOnClick = value;
                });
            }

            scope.$watch('$location.path', function () { closeMenu(); });
            element.parent().bind('click', function () {
                if (!preventCloseOnClick) closeMenu();
                else {
                    event.preventDefault();
                    event.stopPropagation();
                }
...
.directive('pagination', ['paginationConfig', function (config) {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/pagination/pagination.html',
        replace: true,
...
.directive('pager', ['pagerConfig', function (config) {
    return {
        ...
        controller: 'PaginationController',
        templateUrl: bootstrapTemplateBase + '/pagination/pager.html',
        replace: true,
        link: function (scope, element, attrs, paginationCtrl) {
...
.directive('tooltipPopup', function () {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/tooltip/tooltip-popup.html'
    };
})
...
.directive('tooltipHtmlUnsafePopup', function () {
    return {
        ...
        replace: true,
        scope: { content: '@', placement: '@', animation: '&', isOpen: '&' },
        templateUrl: bootstrapTemplateBase + '/tooltip/tooltip-html-unsafe-popup.html'
    };
})
...
.directive('popoverPopup', function () {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/popover/popover.html'
    };
})
...
.directive('progress', function () {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/progressbar/progress.html',
...
.directive('progressbar', ['$transition', function ($transition) {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/progressbar/bar.html',
...
.directive('rating', ['ratingConfig', '$parse', function (ratingConfig, $parse) {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/rating/rating.html',
        replace: true,
        link: function (scope, element, attrs) {
...
.directive('tabset', function () {
    return {
        ...
        templateUrl: bootstrapTemplateBase + '/tabs/tabset.html',
...
function ($parse, $http, $templateCache, $compile) {
    return {
        ...
        restrict: 'EA',
        replace: true,
        templateUrl: bootstrapTemplateBase + '/tabs/tab.html',
        transclude: true,
        scope: {
            heading: '@',
...
.directive('tabsetTitles', function ($http) {
    return {
        restrict: 'A',
        require: '^tabset',
        templateUrl: bootstrapTemplateBase + '/tabs/tabset-titles.html',
        replace: true,
...
.directive('timepicker', ['padFilter', '$parse', 'timepickerConfig', function (padFilter, $parse, timepickerConfig) {
    return {
        ...
        require: 'ngModel',
        replace: true,
        templateUrl: bootstrapTemplateBase + '/timepicker/timepicker.html',
        scope: {
            model: '=ngModel'
        },
        link: function (scope, element, attrs, ngModelCtrl) {
            ...
            var min = timepickerConfig.min;
            if (attrs.min) {
                scope.$parent.$watch($parse(attrs.min), function (value) {
                    min = value ? new Date(value) : null;
                });
            }

            var max = timepickerConfig.max;
            if (attrs.max) {
                scope.$parent.$watch($parse(attrs.max), function (value) {
                    max = value ? new Date(value) : null;
                });
            }
 ...
 */
  ...
  .directive('typeaheadPopup', function () {
      return {
          ...
          replace: true,
          templateUrl: bootstrapTemplateBase + '/typeahead/typeahead-popup.html',
          link: function (scope, element, attrs) {
  ...
  .directive('typeaheadMatch', ['$http', '$templateCache', '$compile', '$parse', function ($http, $templateCache, $compile, $parse) {
      return {
          ...
          link: function (scope, element, attrs) {
              var tplUrl = $parse(attrs.templateUrl)(scope.$parent) || bootstrapTemplateBase + '/typeahead/typeahead-match.html';
